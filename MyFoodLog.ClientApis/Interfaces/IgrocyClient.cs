...
namespace MyFoodLog.ClientApis.Interfaces
{
    ...
    public partial class Product
    {
        ...
        [Newtonsoft.Json.JsonProperty("auto_reprint_stock_label", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class ProductDetailsResponse
    {
        ...
        [Newtonsoft.Json.JsonProperty("default_quantity_unit_consume", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public QuantityUnit Default_quantity_unit_consume { get; set; }

        [Newtonsoft.Json.JsonProperty("quantity_unit_price", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public QuantityUnit Quantity_unit_price { get; set; }
        ...
        /// </summary>
        [Newtonsoft.Json.JsonProperty("qu_conversion_factor_purchase_to_stock", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double Qu_conversion_factor_purchase_to_stock { get; set; }

        /// <summary>
        /// The conversion factor of the corresponding QU conversion from the product's qu_id_price to qu_id_stock
        /// </summary>
        [Newtonsoft.Json.JsonProperty("qu_conversion_factor_price_to_stock", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public double Qu_conversion_factor_price_to_stock { get; set; }
    ...
    public enum ExposedEntity
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"quantity_unit_conversions_resolved")]
        Quantity_unit_conversions_resolved = 29,

        [System.Runtime.Serialization.EnumMember(Value = @"recipes_pos_resolved")]
        Recipes_pos_resolved = 30,
    ...
    public enum ExposedEntityNoEdit
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"quantity_unit_conversions_resolved")]
        Quantity_unit_conversions_resolved = 7,

        [System.Runtime.Serialization.EnumMember(Value = @"recipes_pos_resolved")]
        Recipes_pos_resolved = 8,
    ...
    public enum ExposedEntityNoDelete
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"quantity_unit_conversions_resolved")]
        Quantity_unit_conversions_resolved = 6,

        [System.Runtime.Serialization.EnumMember(Value = @"recipes_pos_resolved")]
        Recipes_pos_resolved = 7,
    ...
    public enum ExposedEntity_IncludingUserEntities
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"quantity_unit_conversions_resolved")]
        Quantity_unit_conversions_resolved = 15,
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"shopping_locations")]
        Shopping_locations = 23,

        [System.Runtime.Serialization.EnumMember(Value = @"stock")]
        Stock = 24,

        [System.Runtime.Serialization.EnumMember(Value = @"stock_current_locations")]
        Stock_current_locations = 25,
    ...
    public enum ExposedEntity_NotIncludingNotListable
    {
        ...
        [System.Runtime.Serialization.EnumMember(Value = @"quantity_unit_conversions_resolved")]
        Quantity_unit_conversions_resolved = 14,
